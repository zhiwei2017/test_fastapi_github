...
import click
import logging
from test_fastapi_github.app.utils.logging import ColorFormatter, request_msg_format
...
class TestColorFormatter:
    ...
    @mock.patch("test_fastapi_github.app.utils.logging.click.style",
    ...
    @mock.patch("test_fastapi_github.app.utils.logging.logging.Formatter")
