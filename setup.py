...
NAME = 'test_fastapi_github'
SHORT_DESCRIPTION = "jeroenjanssens"
URL = "https://github.com/zhiwei2017/test-fastapi-github"
AUTHOR = 'Zhiwei Zhang'
EMAIL = 'zhiwei2017@gamil.com'
...
setup(name=NAME,
      ...
      url=URL,
      packages=find_packages(include=["test_fastapi_github*"],
